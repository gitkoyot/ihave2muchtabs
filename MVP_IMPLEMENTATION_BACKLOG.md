...
- Scale: 200-300 bookmarks.
- Output language: English summaries and answers.

## Delivery Strategy

- Phase 1: Working ingestion pipeline for a subset of bookmarks.
...
## Sprint 2: Bookmark Ingestion + Local Persistence

### Goals

- Read bookmarks from Chrome.
...
1. Bookmark scanner
- Flatten bookmark tree via `chrome.bookmarks.getTree`.
...
- Selected folder bookmarks are ingested and stored.
...
- At least 10 bookmarks can be analyzed end-to-end.
...
- User can ask a Spring-related question and receive URL-backed results.
...
- User can identify analyzed bookmarks and manually delete them safely.
